  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center pt-24 pb-16 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 50% at 50% -10%, rgba(255,92,0,0.10), transparent 70%)," +
            "radial-gradient(ellipse 50% 40% at 80% 80%, rgba(0,212,168,0.06), transparent 60%)",
        }}
      />
      ...
      <div className="section-container relative z-10">
        <div className="max-w-4xl">
          {/* Badge */}
          <div
            className="badge-accent mb-8 animate-fade-up"
          ...
          >
            <Link href={hero.cta_primary.href} className="btn-primary btn-lg group">
              {hero.cta_primary.label}
            </Link>
            <Link href={hero.cta_secondary.href} className="btn-ghost btn-lg">
          ...
          {/* Trust line */}
          <p
            className="mt-6 text-xs text-text-tertiary tracking-wide animate-fade-up"
      ...
      >
        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div
            key={i}
            className="absolute inset-0 border border-[rgba(255,255,255,0.03)] rounded-full animate-float"
            style={{
              inset: `${(i - 1) * 60}px`,
